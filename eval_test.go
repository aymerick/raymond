...
var evalTests = []evalTest{
	...
	{"escaping text (1)", "Awesome's", map[string]string{}, "Awesome's"},
	{"escaping text (2)", "Awesome\\", map[string]string{}, "Awesome\\"},
	{"escaping text (3)", "Awesome\\\\ foo", map[string]string{}, "Awesome\\\\ foo"},
	{"escaping text (4)", "Awesome {{foo}}", map[string]string{"foo": "\\"}, "Awesome \\"},
	{"escaping text (5)", " ' ' ", map[string]string{}, " ' ' "},

	{"escaping expressions (6)", "{{{awesome}}}", map[string]string{"awesome": "&'\\<>"}, "&'\\<>"},
	{"escaping expressions (7)", "{{&awesome}}", map[string]string{"awesome": "&'\\<>"}, "&'\\<>"},
